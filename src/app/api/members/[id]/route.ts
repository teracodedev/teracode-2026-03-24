...
export async function PATCH(request: NextRequest, { params }: Params) {
  ...
  try {
    ...
    const {
      ...
      isAnnaiFuyo, isKeijiFuyo, isNotePrintDisabled, isMeinichiFusho,
    } = body;
    ...
    if (isAnnaiFuyo         !== undefined) updateData.isAnnaiFuyo         = Boolean(isAnnaiFuyo);
    if (isKeijiFuyo         !== undefined) updateData.isKeijiFuyo         = Boolean(isKeijiFuyo);
    if (isNotePrintDisabled !== undefined) updateData.isNotePrintDisabled = Boolean(isNotePrintDisabled);
    if (isMeinichiFusho     !== undefined) updateData.isMeinichiFusho     = Boolean(isMeinichiFusho);
